...
@Component({
  selector: 'app-meet-formations',
  templateUrl: './meet-formations.component.html',
  styleUrls: ['./meet-formations.component.css']
})
export class MeetFormationsComponent implements OnInit, AfterViewInit {
