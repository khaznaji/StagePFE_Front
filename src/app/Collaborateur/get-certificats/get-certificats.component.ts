...
@Component({
  selector: 'app-get-certificats',
  templateUrl: './get-certificats.component.html',
  styleUrls: ['./get-certificats.component.css']
})
export class GetCertificatsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.posteService.getCertifUser(userId).subscribe(
      (data) => {
        this.userInfo = data;
