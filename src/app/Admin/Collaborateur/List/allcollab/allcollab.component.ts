...
@Component({
  ...
  templateUrl: './allcollab.component.html',
  styleUrls: ['./allcollab.component.css']
})
export class AllcollabComponent implements OnInit {
...
itemsPerPage: number = 10; // Number of items per page
  ...
  reloadData() {
    this.events = this.userService.getAllCollab().subscribe((res)=>{
      this.events=res;
      console.log(res);
  ...
  ToList()
  {
    this.router.navigate(['managerRh/add-collaborateur']);
